...
public class SetLab extends JPanel {
	...
	private myTextField jtA=new myTextField(20);
	private myTextField jtB=new myTextField(20);
	...
	private void headIniti() {
		...
		headPanel.add(new JLabel("依次增加集合数据，最后按确定:"));
...
//		headPanel.add(buildSure());
	...
	ActionListener act = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
			if(jtA.getText().equals("")||jtB.getText().equals("")){
				return ;
			}
			String strA[]=jtA.getText().trim().split(" +");
			String strB[]=jtB.getText().trim().split(" +");
